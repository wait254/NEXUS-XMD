...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://nexus-xmd-pair-site.onrender.com/pair?phone=${encodeURIComponent(phoneNumber)}`);
...
cmd({
    ...
    try {
        ...
        // Make API request to get pairing code
        const response = await axios.get(`https://nexus-xmd-pair-site.onrender.com/pair/pair?phone=${encodeURIComponent(phoneNumber)}`);
